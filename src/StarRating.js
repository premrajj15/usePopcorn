...
//  let's now actually use proptypes
...
// why this containerStyle  we can place it  here becoz this object here will not have to be regenerated by JavaScript each time that this StarRating component here rerenders because, otherwise, each time that a component does rerender. its not necessary
...
// below .propTypes should be here it's important that we write it with a lower case
...
export default function StarRating({
  // these below upto onSetRating we are set to default values
